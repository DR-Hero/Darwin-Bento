			...
			';
				...
				<div class="ui-tabs clear">
					...
					foreach ( $this->sections as $section ) {
						echo '
							<li>
								<a href="#' . mb_strtolower( str_replace( ' ', '_', $section ) ) . '">' . $section . '</a>
							</li>
							';	
					}
					echo '
					...
					<div class="theme-options-links">
						<div class="theme-options-links-inner">';
							...
							echo '<div class="links-section links-support">
								...
								<a href="http://satoristudio.net/bento-manual?utm_source=themeoptions&utm_medium=theme&utm_campaign=theme" target="_blank"><span class="dashicons dashicons-book" style="color:#C1A460;"></span>'.__( 'View theme manual', 'satori' ).'<span class="links-pointer"></span></a>
